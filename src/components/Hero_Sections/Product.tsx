...
export default function Product({ resetPage }: { resetPage: () => void }) {
  return (
    <div className="animate-fadeInUp mx-auto flex max-w-4xl flex-col items-center gap-10 py-10 md:py-20">
      <div className="flex flex-col items-center text-center md:text-left space-y-6">
        <h1 className="text-4xl font-semibold text-black">Our Product</h1>
